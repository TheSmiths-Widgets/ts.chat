...
function Controller() {
    ...
    function _loadOld(refreshEvent) {
        var loadEvent = {
            ...
            success: function(messages) {
                ...
                refreshEvent.hide();
                $.messages.scrollToIndex(messages.length, {
                    animated: false
                });
            },
    ...
    !function() {
        ...
        Ti.App.addEventListener("keyboardframechanged", function(e) {
            e.keyboardFrame.y < Ti.Platform.displayCaps.platformHeight ? $.main.scrollTo(0, e.keyboardFrame.height) : $.main.scrollToBottom();
        });
    }();
    exports.init = init;
